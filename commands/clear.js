module.exports = {
    run: async (message, args) => {
        ...
        message.channel.send(`✔️${size - 1} messages ont été supprimés !`).then(sent => sent.delete({timeout: 5e3}))
    },
    name: 'clear',
    guildOnly: true,
    help: {
        description: 'Cette commande permet de supprimer des message.',
        syntax: '[Nom de la commande + nombre de message]'
    }
}